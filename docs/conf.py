...
version = '.'.join(catwoman.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags
release = catwoman.__version__
...
#import "../../../Applications/anaconda3/lib/python3.7/site-packages/sphinx/sphinx_catalystcloud_theme"

#html_theme_path = [sphinx_catalystcloud_theme.get_html_theme_path()]
# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'catwomandoc'
...
latex_documents = [
    (master_doc, 'catwoman.tex', 'catwoman Documentation',
     'Kathryn Jones', 'manual'),
]
...
man_pages = [
    (master_doc, 'catwoman', 'catwoman Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'catwoman', 'catwoman Documentation',
     author, 'catwoman', 'One line description of project.',
     'Miscellaneous'),
]
